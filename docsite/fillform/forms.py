...
class symform(forms.Form):
    ...
    symptoms3 = forms.CharField(max_length=128, help_text="Please enter the symptom",required = False)
    severety3 = forms.IntegerField( min_value=1,max_value=5,   help_text="Please enter the related sverity",required=False)
